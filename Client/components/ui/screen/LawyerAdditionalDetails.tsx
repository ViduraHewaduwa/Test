  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (profilePicture && !profilePicture.isExisting) {
        ...
        const fileExtension = profilePicture.fileName 
          ? profilePicture.fileName.split('.').pop()
          : 'jpg';
        
        const mimeType = profilePicture.type || `image/${fileExtension}`;
        const filename = profilePicture.fileName || `lawyer_${lawyerId}_${Date.now()}.${fileExtension}`;
