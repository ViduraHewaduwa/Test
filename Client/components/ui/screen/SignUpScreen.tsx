...
import { LAWYER_SPECIALIZATIONS } from "../../types/signup"
const SignUpScreen: React.FC<SignUpScreenProps> = ({ navigation }) => {
  ...
  const handleSpecializationSelect = (specialization: string) => {
    updateFormData("specialization", specialization);
  ...
  const handleSignUp = async () => {
    const { errors: validationErrors, isValid } = validateSignUpForm(
      formData,
      selectedRole
    );
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {currentStep === 1 ? (
          ...
          <RegistrationForm
            ...
            onSpecializationPress={() => setShowSpecializationModal(true)}
          />
        )}
      </ScrollView>
      ...
      <ModalSelection
        ...
        options={LAWYER_SPECIALIZATIONS}
